                  ...
                  mainPanel(
                    ...
                    tabsetPanel( type = "pills",
                      ...
                      tabPanel("Modificación",
                               fluidRow(
                                 column(6, h4("Primera Línea:"),
                                        h3(textOutput("primera"))
                                 ),
                                 column(6, h4("Última Línea:"),
...
server <- function(input, output, session) {
  ...
  texto_entero <- reactive({librocorpus()[[5]]})
  inicio <- reactive({librocorpus()[[6]]})
  final <- reactive({librocorpus()[[7]]})
